...
from crm_pilates.web.presentation.service.classroom_service import get_detailed_classroom
from crm_pilates.web.schema.classroom_response import ClassroomReadResponse, ClassroomCreatedResponse
