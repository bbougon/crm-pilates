...
from crm_pilates.domain.classroom.classroom_creation_command_handler import ClassroomCreationCommandHandler
from crm_pilates.domain.classroom.classroom_patch_command_handler import ClassroomPatchCommandHandler
from crm_pilates.domain.classroom.session.session_checkin_saga_handler import SessionCheckinSagaHandler
from crm_pilates.domain.classroom.session.session_checkout_command_handler import SessionCheckoutCommandHandler
from crm_pilates.domain.classroom.session.session_creation_command_handler import SessionCreationCommandHandler
from crm_pilates.domain.classroom.session.session_in_range_command_handler import SessionInRangeCommandHandler
from crm_pilates.domain.classroom.session.attendee_session_cancellation_saga_handler import AttendeeSessionCancellationSagaHandler
from crm_pilates.domain.client.client_command_handlers import ClientCreationCommandHandler, AddCreditsToClientCommandHandler, \
    DecreaseClientCreditsCommandHandler, RefundClientCreditsCommandHandler
from crm_pilates.domain.commands import ClassroomCreationCommand, ClientCreationCommand, ClassroomPatchCommand, \
    GetNextSessionsCommand, SessionCreationCommand, GetSessionsInRangeCommand, SessionCheckoutCommand, \
    AddCreditsToClientCommand, DecreaseClientCreditsCommand, RefundClientCreditsCommand
...
from crm_pilates.event.event_subscribers import SessionCheckedInEventSubscriber, SessionCheckedOutEventSubscriber
...
SessionCheckedOutEventSubscriber(CommandBusProvider.command_bus).subscribe(EventBusProvider.event_bus)
