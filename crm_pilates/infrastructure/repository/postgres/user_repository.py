...
from crm_pilates.infrastructure.repository.postgres.postgres_repository import PostgresRepository, Mapper
...
class UserMapper(Mapper):
    ...
    def values(self) -> list[Union[str, int, Any]]:
        return [str(self.__user.id), self.__user.username, self.__user.password, self.__user.config]
