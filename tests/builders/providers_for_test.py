...
class RepositoryProviderForTest(ProviderForTest):
    ...
    def for_classroom(
        self, classroom_repository: ClassroomRepository = None
    ) -> RepositoryProviderForTest:
        self.repositories["classroom"] = (
            classroom_repository or MemoryClassroomRepository()
        )
        return self
    ...
    def for_client(self, client_repository: ClientRepository = None):
        ...
        self.repositories["attendee"] = MemoryAttendeeRepository(
            client_repository
        ) or MemoryAttendeeRepository(MemoryClientRepository())
        return self
