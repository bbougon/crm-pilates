...
from tests.faker.custom_authentication_service import CustomAuthenticationService, UnauthorizedAuthenticationService
...
def test_should_return_unauthorized_if_authentication_fails():
    app.dependency_overrides[concrete_authentication_service] = UnauthorizedAuthenticationService
